# Contributing to `react-router-dom-utils`

Love react-router-dom-utils and want to help? Thanks so much, there's something to do for everybody!
...
The [issue tracker](https://github.com/yeutech-lab/react-router-dom-utils/issues) is
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork, and configure the remotes:
   ...
   git clone https://github.com/<your-username>/react-router-dom-utils.git
   # Navigate to the newly cloned directory
   cd react-router-dom-utils
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/kopax/react-router-dom-utils.git
   ```
...
owners to license your work under the terms of the [MIT License](https://github.com/yeutech-lab/react-router-dom-utils/blob/master/LICENSE.md).
